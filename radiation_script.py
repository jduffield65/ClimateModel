...
# grey_world = Model.radiation.grey.GreyGas(nz=100, ny=1, tau_lw_func=OpticalDepthFunctions.scale_height,
#                                           tau_lw_func_args=[4,4])
# swEqb = Model.radiation.grey.ShortWavelengthEqbCalc(grey_world.F_stellar_constant, grey_world.albedo,
#                                                     (3e-5, 5), (1e-5, 2))
# # plt.plot(grey_world.T, grey_world.p)
# p = np.linspace(0, p_surface, 100)
# q, opt_depth = OpticalDepthFunctions.exponential(p, 0.00001)
# # q, opt_depth = grey_world.optical_depth_peak_in_atmosphere(p, 100, 2)
# plt.plot(p, opt_depth)
# plt.show()
# tau_function = OpticalDepthFunctions.exponential
# tau_lw_surface = 5
# tau_lw_alpha = 9e-5
# tau_sw_surface = 0.3  # 0.2
# tau_sw_alpha = tau_lw_alpha / 3  # Have to have tau_lw_alpha = integer x tau_sw_alpha
# tau_sw_alpha = 0


# tau_function = OpticalDepthFunctions.peak_in_atmosphere
# tau_lw_surface = 100000
# tau_lw_alpha = 1e-4
# tau_sw_surface = 40000
# tau_sw_alpha = 1e-5
...
grey_world = Model.radiation.grey.GreyGas(nz='auto', tau_lw_func=OpticalDepthFunctions.exponential,
                                          tau_lw_func_args=[1, 4], tau_sw_func=OpticalDepthFunctions.exponential,
                                          tau_sw_func_args=[1/5, 0.6])
'''With stratosphere'''
# grey_world = Model.radiation.grey.GreyGas(nz='auto', tau_lw_func=OpticalDepthFunctions.exponential,
#                                           tau_lw_func_args=[1, 4], tau_sw_func=OpticalDepthFunctions.peak_in_atmosphere,
#                                           tau_sw_func_args=[3, 2000, 0.5])
'''With mesosphere'''
# grey_world = Model.radiation.grey.GreyGas(nz='auto', tau_lw_func=OpticalDepthFunctions.scale_height_and_peak_in_atmosphere,
#                                           tau_lw_func_args=[1, 4, 100, 600, 0.3], tau_sw_func=OpticalDepthFunctions.peak_in_atmosphere,
#                                           tau_sw_func_args=[10, 2000, 0.05])
'''With thermosphere'''
# grey_world = Model.radiation.grey.GreyGas(nz='auto', tau_lw_func=OpticalDepthFunctions.scale_height_and_peak_in_atmosphere,
#                                           tau_lw_func_args=[1, 4, 1000, 600, 0.1], tau_sw_func=OpticalDepthFunctions.scale_height_and_peak_in_atmosphere,
#                                           tau_sw_func_args=[0.05, 0.1, 1000, 20, 0.002])
...
""" Evolution with tau"""
# tau_params_final = [1, 6]
# tau_params = [1, 4]
# p_max = 2000
# tau_sw_params_final = [1/3, 2000, 1.2]
# tau_sw_params = [1/3, 2000, 0]
# grey_world = Model.radiation.grey.GreyGas(nz='auto', tau_lw_func=OpticalDepthFunctions.exponential,
...
#     t_array.append(t)
#     T_array.append(grey_world.T.copy())
#     tau_array.append(grey_world.tau.copy())
#     tau_sw_array.append(grey_world.tau_sw.copy())
#     if min(grey_world.T)[0] < 0:
#         raise ValueError('Temperature is below zero')
#
# anim = grey_world.plot_animate(T_array, t_array, T_eqb, correct_solution, tau_array, tau_sw_array)
# plt.show()
